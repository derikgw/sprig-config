...
The `injection.py` module provides Spring Boot-style AOP (Aspect-Oriented Programming) configuration injection for SprigConfig. It implements three patterns for declarative configuration binding:
